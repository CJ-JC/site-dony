  ...
  return (
    <div className="mx-auto max-w-screen-xl">
      <div className="space-y-4 p-6">
        <h1>Conditions Générales de Vente (CGV) de Donymusic</h1>
        ...
        <p>
          ...
          l'utilisateur a validé le paiement et a reçu un email de confirmation
          de la part de <strong>Donymusic</strong>. Cette confirmation marque la
