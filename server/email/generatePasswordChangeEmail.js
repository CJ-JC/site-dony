export const generatePasswordChangeEmail = () => {
    ...
    <section class="mx-auto max-w-2xl bg-white px-6 py-8 dark:bg-gray-900"> 
        <main class="mt-8">
            ...
            <p class="text-gray-600 dark:text-gray-300>Si vous n'êtes pas à l'origine de cette modification, veuillez nous contacter immédiatement à l'adresse <a href="mailto:contact@donymusic.fr">contact@donymusic.fr</a>.</p>
        </main>
